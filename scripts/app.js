...
var Graf = /** @class */ (function (_super) {
    __extends(Graf, _super);
    function Graf() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Graf.prototype.getData = function () {
        var data = [
            {
    ...
    Graf.prototype.render = function () {
        ...
        return React.createElement(ReactD3.LineChart, { margins: margins, title: title, data: this.getData(), width: width, height: height, chartSeries: chartSeries, x: x });
    };
    return Graf;
}(React.Component));
/// <reference path="tomovo.tsx" />
